...
type LogClient interface {
	...
	SyncLogBuffers(ctx context.Context, in *SyncLogRequest, opts ...grpc.CallOption) (*SyncLogReply, error)
}
...
func (c *logClient) SyncLogBuffers(ctx context.Context, in *SyncLogRequest, opts ...grpc.CallOption) (*SyncLogReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SyncLogReply)
	err := c.cc.Invoke(ctx, Log_SyncLogBuffers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LogServer interface {
	// rpc SyncLogBuffers (stream SyncLogRequest) returns (SyncLogReply) {}
	SyncLogBuffers(context.Context, *SyncLogRequest) (*SyncLogReply, error)
...
func (UnimplementedLogServer) SyncLogBuffers(context.Context, *SyncLogRequest) (*SyncLogReply, error) {
	return nil, status.Error(codes.Unimplemented, "method SyncLogBuffers not implemented")
}
...
func _Log_SyncLogBuffers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SyncLogRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LogServer).SyncLogBuffers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Log_SyncLogBuffers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogServer).SyncLogBuffers(ctx, req.(*SyncLogRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (UnimplementedControlServer) ApplyControl(grpc.ClientStreamingServer[ControlRequest, ControlReply]) error {
	return status.Error(codes.Unimplemented, "method ApplyControl not implemented")
}
...
func (UnimplementedCoordinateServer) CoordinateLog(context.Context, *CoordinateLogRequest) (*CoordinateLogReply, error) {
	return nil, status.Error(codes.Unimplemented, "method CoordinateLog not implemented")
}
func (UnimplementedCoordinateServer) CoordinateCtrl(context.Context, *CoordinateCtrlRequest) (*CoordinateCtrlReply, error) {
	return nil, status.Error(codes.Unimplemented, "method CoordinateCtrl not implemented")
}
...
func RegisterCoordinateServer(s grpc.ServiceRegistrar, srv CoordinateServer) {
	// If the following call panics, it indicates UnimplementedCoordinateServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
