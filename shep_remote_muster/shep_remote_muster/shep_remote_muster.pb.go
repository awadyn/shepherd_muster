...
var file_shep_remote_muster_shep_remote_muster_proto_rawDesc = []byte{
	...
	0x52, 0x0c, 0x63, 0x74, 0x72, 0x6c, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x22, 0x4c,
	...
	0x79, 0x22, 0x00, 0x28, 0x01, 0x32, 0x53, 0x0a, 0x0a, 0x43, 0x6f, 0x6f, 0x72, 0x64, 0x69, 0x6e,
	0x61, 0x74, 0x65, 0x12, 0x45, 0x0a, 0x0b, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x52,
...
var file_shep_remote_muster_shep_remote_muster_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_shep_remote_muster_shep_remote_muster_proto_goTypes = []interface{}{
	...
	(*CompleteRunRequest)(nil), // 8: muster.CompleteRunRequest
	(*CompleteRunReply)(nil),   // 9: muster.CompleteRunReply
}
var file_shep_remote_muster_shep_remote_muster_proto_depIdxs = []int32{
	...
	8, // 5: muster.Coordinate.CompleteRun:input_type -> muster.CompleteRunRequest
	1, // 6: muster.Pulse.HeartBeat:output_type -> muster.HeartbeatReply
	4, // 7: muster.Log.SyncLogBuffers:output_type -> muster.SyncLogReply
	7, // 8: muster.Control.ApplyControl:output_type -> muster.ControlReply
	9, // 9: muster.Coordinate.CompleteRun:output_type -> muster.CompleteRunReply
