...
//TODO replace with sheep.log_buffer_map 
// where each entry represents a log object of this sheep
// and each log object feeds from a resizable memory buffer
// rather than feeding from a file object
func (s *shepherd) init_log_buffers() {
}
